angular.module('MetronicApp').controller('studentExecuseRecordsController',
    function (DTOptionsBuilder, DTColumnBuilder,$q,$stateParams, $rootScope, $scope, $http, $window, localStorageService, toastr, $filter,studentExcuseService) {
        ...
        var model = {
            ...
            options: DTOptionsBuilder.fromFnPromise(function () {
                var defer = $q.defer();
                studentExcuseService.getStudentExcuseRecord(schoolId,studentId).then(function (record) {
